...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-BMazYTYt.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"1bd20e620b68": async () => {
		const m = await import("./assets/StudyExperience-hTdm6-SQ.js");
		return { get "StudyExperience"() {
			return m["StudyExperience"];
		} };
	},
	"26f84f7086d2": async () => {
		const m = await import("./assets/StatisticsDashboard-D7nLyJXB.js");
		return { get "StatisticsDashboard"() {
			return m["StatisticsDashboard"];
		} };
	},
	"339f946bc456": async () => {
		const m = await import("./assets/Icon-Df4RYgCR.js").then((n) => n.n);
		return { get "default"() {
			return m["default"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-Dtw87Uex.js");
		return {
			get "ErrorBoundary"() {
	...
	"75988a7207f7": async () => {
		const m = await import("./assets/LibraryClient-DyGEPolb.js");
		return { get "LibraryClient"() {
			return m["LibraryClient"];
		} };
	},
	"8c0f216c4604": async () => {
	...
	"a9fc8a8a75c7": async () => {
		const m = await import("./assets/SettingsClient-OxO6J4Cd.js");
		return { get "SettingsClient"() {
			return m["SettingsClient"];
		} };
	},
	"b6ffcc9998c8": async () => {
		const m = await import("./assets/PwaRegister-C5B6Jvjl.js");
		return { get "PwaRegister"() {
			return m["PwaRegister"];
		} };
	},
	"c2747888630f": async () => {
		const m = await import("./assets/link-0oMwb4X1.js").then((n) => n.n);
		return { get "default"() {
			return m["default"];
		} };
	},
	"d0c94b726abe": async () => {
		const m = await import("./assets/GBSHeader-B1spFlQa.js");
		return { get "GBSHeader"() {
			return m["GBSHeader"];
		} };
	}
};
